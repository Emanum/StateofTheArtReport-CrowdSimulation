...
The paper "Hierarchical model for real time simulation of virtual human crowds" \cite{musse_hierarchical_2001} \label{exp:musse_hierarchical_2001} presents a crowd simulation system named ViCrowd. 
...
"Crowds by Example" \cite{lerner_crowds_2007} \label{exp:lerner_crowds_2007} have a completely different approach than other crowd simulation models. They simulate a crowd without the need for social rules or agents' perceptions. The system only relies on given input data in the form of videos from real world crowds.
